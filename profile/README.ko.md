...
- 🧰 **[devslab-kit](https://github.com/devslab-kr/devslab-kit)** &nbsp;[![Maven Central](https://img.shields.io/maven-central/v/kr.devslab/devslab-kit-spring-boot-starter)](https://central.sonatype.com/artifact/kr.devslab/devslab-kit-spring-boot-starter) — 인증, RBAC+그룹+ABAC, 멀티테넌시, 동적 메뉴, 감사 로깅, 관리자 REST API를 자동 구성으로 제공하는 Spring Boot 4 플랫폼 스타터. 전체 문서는 [devslab-kit.devslab.kr](https://devslab-kit.devslab.kr).
